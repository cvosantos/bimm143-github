...
If the `rowSums()` is zero then a given gene (i.e. row) has no couint
...
```
    ...
    Warning: ggrepel: 14495 unlabeled data points (too many overlaps). Consider
...
```
    ...
    hsa04110 Cell cycle 8.995727e-06 -4.378644 8.995727e-06 0.001448312      121
                                exp1
...
```
    ...
    Info: Working in directory /Users/ciennasantos/Documents/school/bimm143/bimm143-github/class14
