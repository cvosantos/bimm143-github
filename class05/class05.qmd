...
For "simple" plots ggplot is much more verbose than base R but the defaults are nicer and and for complicated plots it becomes much more efficient and structured.
